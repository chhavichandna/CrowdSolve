...
//   location: String,
//   image: String,
//   likes: [{ type: mongoose.Schema.Types.ObjectId, ref: 'User' }], // ❤️ like system
...
//     question.answers.push({ user: req.user.id, answer });
//     await question.save();
...
//     await question.save();
//     res.json({ likes: question.likes.length, liked: !alreadyLiked });
//   } catch (err) {
//     res.status(500).json({ msg: err.message });
//   }
// });
