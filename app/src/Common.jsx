    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 text-gray-200 transition-all duration-500">
      ...
      <nav className="w-full p-4 flex items-center justify-between bg-opacity-20 backdrop-blur-sm bg-gradient-to-t from-[#020617] via-[#0f172a] to-[#1e293b]">
        <div className="flex items-center gap-4">
          <Link
            to="/dash"
            className="text-2xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-lg"
          >
            CrowdSolve
          </Link>
          <div className="hidden md:block">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            to="/dash"
            className="relative inline-block text-sm font-medium text-white hover:text-violet-300 transition-colors duration-300 after:block after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-gradient-to-r after:from-purple-400 after:to-violet-400 hover:after:w-full after:transition-all after:duration-300"
          >
            Dashboard
          </Link>
          <button
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="text-center py-10">
            ...
            <p className="text-gray-400 mt-3 text-lg">
              Discover ideas, discuss solutions, and build knowledge together
              every day. 🌟
            </p>
          </div>
          ...
          <div className="space-y-10 max-w-4xl mx-auto">
            {questions.map((q) => (
              <div
                key={q._id}
                className="bg-gray-800 rounded-lg shadow-md p-6 border border-gray-700 transform transition hover:-translate-y-1"
              >
